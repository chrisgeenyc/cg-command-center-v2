...
import { NOTES, NoteItem } from '@/lib/data';
...
function NoteRow({ note, active, onClick }: { note: NoteItem; active: boolean; onClick: () => void }) {
  return (
      ...
      <div className="notes-shell">
        <aside className="notes-list">
          ...
          <div className="notes-filters">
            ...
            <div className="notes-filter untagged" onClick={() => setFilter("untagged")}>
          ...
          <div className="notes-rows">
            {NOTES.map(n => (
              <NoteRow key={n.id} note={n} active={n.id === activeId} onClick={() => setActiveId(n.id)} />
            ))}
          </div>
        </aside>
